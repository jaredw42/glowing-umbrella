...
//  rtcmdecoder
//
//  Created by Jared Wilson on 1/19/18.
//  Copyright © 2018 Jared Wilson. All rights reserved.
//
...
void readheader(void){
    ...
    if (bool_mtype){
        fprintf(header,"%2.0d ",message_type);
    }
    
    if (bool_refid){
        fprintf(header,"%4.0d ",station_id);
    }
